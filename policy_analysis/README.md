...
uv run python -m  src.policy_analysis.agentic_data_policies_extraction.main
```

[Voir ici pour plus d'infos](src/policy_analysis/agentic_data_policies_extraction/policies_transformation_to_matrices/README.md)
