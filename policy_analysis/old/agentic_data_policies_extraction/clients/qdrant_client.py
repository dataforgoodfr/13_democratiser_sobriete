...
QDRANT_URL = os.getenv(
    "QDRANT_URL", "116919ed-8e07-47f6-8f24-a22527d5d520.europe-west3-0.gcp.cloud.qdrant.io"
)
    ...
    def __init__(self, url: str = None, api_key: str = None, collection_name: str = None):
        ...
        try:
            ...
            if self.api_key and self.api_key != "None":
                self.client = QdrantClientLib(url=self.url, api_key=self.api_key)
            else:
    ...
    def get_text_by_id(self, point_id: str) -> Optional[Dict[str, Any]]:
        ...
        try:
            ...
            if points and len(points) > 0:
                point = points[0]
                return {"id": point.id, "payload": point.payload, "vector": point.vector}
            else:
