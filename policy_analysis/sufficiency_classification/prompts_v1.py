...
PROMPT_VERSION = "v1-expert-5class-10sub"
...
Use `ambiguous` when the text IS a policy but the mechanism is genuinely
unclear (mixed rationale, or evidence points to more than one category
with no dominant one).
"""
