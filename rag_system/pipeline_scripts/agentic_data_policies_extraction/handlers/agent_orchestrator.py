...
from ..prompts.agent_prompts import (get_actor_agent_prompt,
...
class AgentOrchestrator:
    ...
    def coordinate_and_validate(self, conclusion_text: str, extracted_data: Dict) -> Dict:
        ...
        prompt = get_coordinator_agent_prompt(
            conclusion_text, json.dumps(extracted_data, indent=2)
        )
        response = self._call_agent(prompt)
    ...
    def extract_data_with_agents(self, conclusion_text: str) -> Dict[str, Any]:
        ...
        for item in items:
            ...
            for factor in factors:
                ...
                item_data["FACTOR"][factor] = {"CORRELATION": correlation}
