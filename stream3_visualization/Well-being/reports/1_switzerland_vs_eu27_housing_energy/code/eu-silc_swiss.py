"""
EU-SILC Tenure Analysis by Age Groups and Income Deciles - SWITZERLAND
=========================================================================
...
def create_heatmaps():
    ...
    plt.savefig(OUTPUT_DIR / "heatmap_ownership_by_age_and_decile_CH.png", dpi=300, bbox_inches='tight')
    print(f"\nHeatmap saved: {OUTPUT_DIR / 'heatmap_ownership_by_age_and_decile_CH.png'}")
...
def main():
    print("="*70)
    print("EU-SILC Tenure Analysis by Age Groups and Income Deciles - SWITZERLAND")
    print("="*70)
    print(f"Period: 2007-2022 (available data for Switzerland)")
