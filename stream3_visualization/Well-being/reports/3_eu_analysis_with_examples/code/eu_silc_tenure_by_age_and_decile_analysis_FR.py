"""
EU-SILC Tenure Analysis by Age Groups and Income Deciles - FRANCE
===================================================================
...
OUTPUT_DIR = Path(__file__).parent.parent / "outputs" / "graphs" / "EU-SILC" / "by_age_and_decile_FR"
...
def create_heatmaps():
    ...
    plt.savefig(OUTPUT_DIR / "heatmap_ownership_by_age_and_decile_FR.png", dpi=300, bbox_inches='tight')
    print(f"\nHeatmap saved: {OUTPUT_DIR / 'heatmap_ownership_by_age_and_decile_FR.png'}")
    ...
    csv_path = OUTPUT_DIR / "ownership_by_age_and_decile_FR.csv"
...
def main():
    print("="*70)
    print("EU-SILC Tenure Analysis by Age Groups and Income Deciles - FRANCE")
    print("="*70)
