"""
France Report – Carbon Budget Neutrality Year Maps
Generates the 4-scenario map (shared legend) for rep_fr countries:
  FR, ES, IT, CH, DE, BE

Output: stream3_visualization/Budget/code/reports/FR/
"""
...
OUTPUT_DIR = Path(__file__).parent / 'FR'
...
# rep_fr comparison group
COUNTRIES = ['FR', 'ES', 'IT', 'CH', 'DE', 'BE']
...
# ============================================================================
print('=' * 70)
print('FRANCE REPORT – NEUTRALITY YEAR MAPS')
print('=' * 70)
...
def _plot_neutrality_map(ax, gdf, col, cmap, norm, title, study_set, bg):
    ...
    ax.set_axis_off()
    # Crop to FR comparison group extent
    ax.set_xlim(2_400_000, 5_200_000)
    ax.set_ylim(1_300_000, 3_800_000)
...
fig.suptitle(f'Year to Carbon Neutrality – France & Comparison Countries\n{WARMING} warming, {PROBABILITY} probability',
