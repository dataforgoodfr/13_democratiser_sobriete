...
### EU/Switzerland Data Processing (Simplified):
```bash
cd Decomposition
...
### World Data Processing (Sequential):

For processing world/REMIND data specifically, run these scripts **in sequence**:

```bash
cd Decomposition

# Step 1: Transform REMIND data to European format
python code/transform_world_to_european_format.py

# Step 2: Process transformed data for decomposition analysis  
python code/world_data_preprocessing.py
```
