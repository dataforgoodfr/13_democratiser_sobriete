"""
Visualisation EUROSTAT - Prix de l'électricité en France par bande de consommation
...
# ============================================================================
print("="*80)
print("VISUALISATION EUROSTAT - PRIX DE L'ÉLECTRICITÉ EN FRANCE")
print("="*80)

# Load EUROSTAT data
eurostat_file = DATA_PATH / 'nrg_pc_204_c__custom_19587405_electricity.csv'
...
print(f"  Fichier: nrg_pc_204_c__custom_19587405_electricity.csv")
...
# Map nrg_cons values to codes
# Extract the pattern from nrg_cons column
nrg_cons_mapping = {
...
# Desired order of consumption bands
...
ax.set_title('Composition des Prix de l\'Électricité en France (2024)\npar Bande de Consommation',
...
# Save figure
output_file = OUTPUT_DIR / 'FR_Electricity_Prices_Composition_2024.png'
...
print("="*80)
print(f"\nFichier généré:")
print(f"  FR_Electricity_Prices_Composition_2024.png")
